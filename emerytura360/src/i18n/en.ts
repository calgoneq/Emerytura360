export const EN = {
  ...
  hero_sub: 'See how much you may receive — with explanations of valorization, sick-leave impact, and “what-if” scenarios.',
  cta_start: 'Start simulation',
  cta_how: 'See how it works',
  expected_label: 'What monthly pension would satisfy you? (PLN)',
  expected_hint: 'Optional — used as your “target” on charts.',
  expected_ok: 'OK',
